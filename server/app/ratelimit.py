...
#
# 📌 한도의 기준은 예산이 아니라 **하루 세 판을 여유롭게**다 (2026-08-26).
#    개발용 키를 쓰고 있어 월 5,000원에 맞추지 않기로 했다. 참고용 실측 환산:
#      하루 세 판(신규) = 3 x 159 + 심문 약 90회 x 0.68 + 3 x 4.91 = 약 553원/일
#      매일 그만큼 하면 약 16,600원/월. 상한까지 태우면 150판 x 159 = 23,850원/월.
#    예산에 맞춰야 할 상황이 오면 조이는 곳은 `rate_limit_start_global`의 월 한도다
#    (초상화 3장이 사건 생성 비용의 93%).
#
