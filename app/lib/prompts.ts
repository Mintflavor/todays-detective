...

{
  ...
  "victim_info": {
    "name": "피해자 이름 (순수 한글)",
    "damage_details": "직접적인 사인 또는 피해 내용 (예: 둔기에 의한 두부 손상, 금고 털림, 명화 도난)",
    "body_condition": "시신 또는 현장의 상태 묘사 (예: 안경이 깨져 있고 바닥을 향해 엎드려 있음, 진열장이 부서져 있음)",
    "incident_time": "사건 발생 추정 시각 (예: 사망 추정 시각, 도난 발생 시각)"
  },
